...
class CategoryController {
    getCategory = (req, res) => {
        ...
        const categoryProducts = products.filter(({ parentId }) => parentId === id);
        const categoryCategories = categories.filter(({ parentId }) => parentId === id);
        category.products = categoryProducts ? categoryProducts : [];
        category.categories = categoryCategories ? categoryCategories : [];
